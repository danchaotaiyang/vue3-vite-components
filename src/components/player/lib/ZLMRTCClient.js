export const ZLMRTCClient = (function (exports) {
    'use strict';
    ...
    const BUILD_DATE = 'Sun Apr 27 2025 09:01:20 GMT+0800 (中国标准时间)';
            ...
            this.pc.createOffer().then(desc => {
                ...
                this.pc.setLocalDescription(desc).then(() => {
                    axios({
                        ...
                        // console.log('response.data', ret, navigator.userAgentData);
                        // !!! 正式版本无此段代码
                        ret.sdp = ret.sdp.replace(
                            '\na=ssrc:2 msid:zlmediakit-mslabel zlmediakit-label\r',
                            '\na=ssrc:2 msid:zlmediakit-mslabel zlmediakit-label2\r'
                        );
                        ret.sdp = ret.sdp.replace(
                            '\na=ssrc:1 msid:zlmediakit-mslabel zlmediakit-label\r',
                            '\na=ssrc:1 msid:zlmediakit-mslabel zlmediakit-label1\r'
                        );
                        ret.sdp = ret.sdp.replace(
                            '\na=ssrc:3 msid:zlmediakit-mslabel zlmediakit-label\r',
                            '\na=ssrc:3 msid:zlmediakit-mslabel zlmediakit-label3\r'
                        );

                        ret.sdp = ret.sdp.replace(
                            '\na=msid:zlmediakit-mslabel zlmediakit-label\r\na=ssrc:1 cname:zlmediakit-rtp\r',
                            '\na=msid:zlmediakit-mslabel zlmediakit-label0\r\na=ssrc:1 cname:zlmediakit-rtp\r'
                        );
                        // !!! 正式版本无此段代码
                        let anwser = {};
                        anwser.sdp = ret.sdp;
