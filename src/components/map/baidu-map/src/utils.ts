 ...
 */
export const generateTileUrl = (url: string, x: string, y: string, zoom: string): string => {
 ...
 */
export const getTileUrl = (template: string, x: string, y: string, zoom: string): string | null => {
    try {
